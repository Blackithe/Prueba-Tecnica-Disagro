        ...
        <main className="max-w-6xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-4 sm:mt-0">
              {!mostrarFormulario && (
                <button 
                  ...
                  className="inline-flex items-center justify-center rounded-md bg-disagro-green px-4 py-2 text-xs font-bold uppercase tracking-wider text-white shadow-xs hover:bg-emerald-700 transition-colors cursor-pointer"
                >
                  Agregar Producto
                </button>
              )}
          ...
          <div className="mb-6 max-w-md animate-fadeIn">
            ...
            <input
              ...
              className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 shadow-xs focus:border-disagro-green focus:outline-hidden transition-colors"
            />
          </div>

          {loading ? (
            <div className="text-center py-16">
              <div className="inline-block animate-spin rounded-full h-7 w-7 border-4 border-slate-200 border-t-disagro-green mb-3"></div>
